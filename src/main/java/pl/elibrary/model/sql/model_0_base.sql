...
CREATE TABLE public.user_sessions (
	...
	CONSTRAINT fk_users_sessions FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE
);
...
CREATE TABLE public.books (
	...
	CONSTRAINT fk_book_section_id FOREIGN KEY (section_section_id) REFERENCES sections(section_id)
);
