package pl.elibrary.view.jsf.beans;
...
import pl.elibrary.view.jsf.beans.objects.SectionNode;

/**
 * Managed bean for admin JSF-pages
 */
...
public class SectionService implements Serializable {
	...
	public void appendNode() {
		...
		if(parentSection==null) {
			System.err.println("Parent section not found.");
			return;
		}
